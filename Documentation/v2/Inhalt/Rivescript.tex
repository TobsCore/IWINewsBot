...
\lstinputlisting[firstline=1, lastline=4, caption=Einfaches Rivescript-Programm, label=basicRive]{riveExamples.rive}
...
\lstinputlisting[firstline=3, lastline=5, caption=Gewichtete Ausgaben in Rivescript, label=weight]{riveExamples.rive}
...
\lstinputlisting[firstline=7, lastline=9, caption=Sprachliche Alternativen in Rivescript, label=subs]{riveExamples.rive}
...
\lstinputlisting[firstline=11, lastline=12, caption=Wildcards in Rivescript, label=wildcards]{riveExamples.rive}
...
\lstinputlisting[firstline=15, lastline=18, caption=Arrays in Rivescript, label=array]{riveExamples.rive}
...
\lstinputlisting[firstline=21, lastline=22, caption=Mehrere Formulierungen durch Alternativen in einem Ausdruck, label=alternatives]{riveExamples.rive}
...
\lstinputlisting[language=buildSbt, style=buildSbt, caption=Auszug der build.sbt, label=buildSbt]{build.sbt}
